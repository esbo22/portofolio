...
var loadDynamicBannerText = function loadDynamicBannerText() {
  new typed_js__WEBPACK_IMPORTED_MODULE_0___default.a('#banner-typed-text', {
    strings: ["Je m'appelle Johnny Girault et j'ai 39 ans. <br /> ^1000" + "Je sors de la formation du WAGON à Rennes, <br /> ^500" + "avant cela j’étais technicien n2. <br /> ^500" + "Mon parcours m'a permis d'avoir, <br /> ^100" + "une bonne connaissance des métiers <br /> ^100" + "du digital. <br /> ^1000" + "(plus de détails dans la section Parcours). <br /> ^1000"],
    typeSpeed: 50,
    loop: true
  });
};
...
/***/ "./app/javascript/components/slideleft.js":
/*!************************************************!*\
  !*** ./app/javascript/components/slideleft.js ***!
  \************************************************/
...
$(document).ready(function () {
  ...
  var web_window = $(window); //check to see if any animation containers are currently in view
  ...
  function check_if_in_view() {
    ...
    $.each(animation_elements, function () {
      ...
      var element_bottom_position = element_top_position + element_height; //check to see if this current container is visible (its viewable if it exists between the viewable space of the viewport)
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_banner__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/banner */ "./app/javascript/components/banner.js");
/* harmony import */ var _components_slideleft__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/slideleft */ "./app/javascript/components/slideleft.js");
/* harmony import */ var _components_slideleft__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_slideleft__WEBPACK_IMPORTED_MODULE_1__);

Object(_components_banner__WEBPACK_IMPORTED_MODULE_0__["loadDynamicBannerText"])();

Object(_components_slideleft__WEBPACK_IMPORTED_MODULE_1__["check_if_in_view"])();
...
/******/ });
//# sourceMappingURL=application-032f9faa00d57e5f7ee8.js.map